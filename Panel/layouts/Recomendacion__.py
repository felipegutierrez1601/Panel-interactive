    ...
    recomendacion =html.Div([
       html.Div([
                    ...
                    html.Div([
                        ...
                        html.Div(dcc.Link('Simulación', href='/Simulacion',id='link-2'),className='link', style={'margin-left':442},title='Vista Simulación'),
                        html.Div(dcc.Link('Refuerzo', href='/Refuerzo',id='link-1'),className ='link2',title='Vista Refuerzo'),
                        html.Div(dcc.Link('Recomendación', href='/Recomendacion',id='link-3'),style= {'margin-left' : 248,'margin-top':'2px','font-family': 'Scene', 'padding': '2px 0px','background-color': '#FFFFFF','border-radius': '15px','border': '2px solid #000000','width':'195px','font-size': '1px','height': '37px'},title='Vista Recomendación'),
        ...
        dbc.Card(html.Div([
            ...
            grafico_indicador_movile("S24","Cantidad",{'margin-top' : 50,'margin-left': 1,'margin-right': 0,'width': 160,'height': 100,'textAlign': 'left', 'position': 'absolute'}),
        ...
        dbc.Card(html.Div([
            ...
            grafico_indicador_movile("S15","Cantidad",{'margin-top' : 50,'margin-left': 1,'margin-right': 0,'width': 160,'height': 100,'textAlign': 'left', 'position': 'absolute'}),
        ...
        dbc.Card(html.Div(
            ...
            grafico_indicador_movile("S18","Cantidad",{'margin-top' : 50,'margin-left': 1,'margin-right': 0,'width': 160,'height': 100,'textAlign': 'left', 'position': 'absolute'}),
        ...
        dbc.Card(html.Div(
            ...
            grafico_indicador_movile("chapa","Cantidad",{'margin-top' : 50,'margin-left': 1,'margin-right': 0,'width': 160,'height': 100,'textAlign': 'left', 'position': 'absolute'}),
            ...
            ),id = 'Estado_chapa' ,className = "recomendacion_card_5"),

        dbc.Card(html.Div(
            [
            html.H2('Rendimiento Clear', className = "nombre_clear"),
            grafico_indicador_movile("clear","Cantidad",{'margin-top' : 50,'margin-left': 1,'margin-right': 0,'width': 160,'height': 100,'textAlign': 'left', 'position': 'absolute'}),
            ...
            ),id = 'Estado_clear' ,className = "recomendacion_card_6"),

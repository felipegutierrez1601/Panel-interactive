    ...
    refuerzo = html.Div([
        ...
        html.Div([
                    ...
                    html.Div([
                        ...
                        html.Div(dcc.Link('Recomendación', href='/Recomendacion',id='link-2'),className='link',style={'margin-left':240}),
                        html.Div(dcc.Link('Simulación', href='Simulacion',id='link-1'),className ='link2',style={'margin-left':446}),
                        html.Div(dcc.Link('Refuerzo', href='/Refuerzo',id='link-3'),style= {'margin-left' : 100,'margin-top':'2px','font-family': 'Scene', 'padding': '2px' '5px','background-color': '#FFFFFF','border-radius': '15px','border': '2px solid #000000','width':'140px','font-size': '1px','height': '37px'}),
